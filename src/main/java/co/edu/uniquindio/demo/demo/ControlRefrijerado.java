...
public class ControlRefrijerado implements Initializable {
    ...
    @FXML
    private TableColumn<ProductoRefrigerado, String> jurCantidad;
   ...
   @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        jurCantidad.setCellValueFactory(new PropertyValueFactory<ProductoRefrigerado, String>("Cantidad"));
        jurCodAprovado.setCellValueFactory(new PropertyValueFactory<ProductoRefrigerado, String>("codigoAprovado"));
        jurTemp.setCellValueFactory(new PropertyValueFactory<ProductoRefrigerado, String>("temperaturaRecomendada"));
