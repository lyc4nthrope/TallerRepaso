...
public class ProductoRefrigerado extends Producto{
    ...
    public ProductoRefrigerado(int codigo, String nombre, String descripcion, double valorUnitario, int cantidadExistencia, String codigoAprobado, String tempRecomendada) {
